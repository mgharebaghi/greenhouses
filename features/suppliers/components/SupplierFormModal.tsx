...
import { createSupplier, updateSupplier, getSuppliers } from "@/features/suppliers/services";
...
export default function SupplierFormModal({
    ...
    const isLegal = Form.useWatch("Legal", form);
                            ...
                            <Form.Item
                                ...
                                label={
                                    <span className="text-xs font-semibold text-slate-700 dark:text-slate-300 flex items-center gap-1.5 mb-1">
                                        ...
                                        {field.name === "FirstName" && isLegal ? "نام مدیرعامل" :
                                            field.name === "LastName" && isLegal ? "نام خانوادگی مدیرعامل" :
                                                field.label}
                            ...
                            >
                                {field.type === "switch" ? (
                                    ...
                                    <Input
                                        ...
                                        placeholder={field.placeholder}
                                        disabled={loading ||
                                            (field.name === "CompanyName" && !isLegal) ||
                                            (field.name === "BrandName" && !isLegal)
                                        }
