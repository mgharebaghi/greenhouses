...
import { allGreenHouses, createGreenHouse, updateGreenHouse, GreenHouseCreateRes } from "@/app/lib/services/greenhouse";
import { getAllOwners, OwnerResponse } from "@/app/lib/services/owners";
import {
    CloseOutlined,
    HomeOutlined,
    CheckCircleOutlined,
...
export default function GreenHouseFormModal({
    ...
    const handleSubmit = async (values: any) => {
        ...
        if (isEdit && record) {
            ...
            res = await createGreenHouse(dataToSubmit as Tbl_Greenhouses);
        }
