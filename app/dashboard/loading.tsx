export default function DashboardLoading() {
    return (
        <div className="w-full h-full min-h-[60vh] flex flex-col items-center justify-center transition-all duration-300">
            ...
            <div className="mt-8 flex flex-col items-center gap-2">
                <h3 className="text-lg font-bold text-emerald-800 tracking-wide font-IransansB">
