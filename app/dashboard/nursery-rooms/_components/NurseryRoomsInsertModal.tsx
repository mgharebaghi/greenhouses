...
import { CloseOutlined, ExperimentOutlined, CheckCircleOutlined, ExclamationCircleOutlined, HomeOutlined } from "@ant-design/icons";
...
export default function NurseryRoomsInsertModal({
    open,
    setOpen,
    setLoading,
    setData,
    refreshData
}: NurseryRoomsInsertModalProps) {
        ...
        >
            ...
            <div className="relative px-6 py-6 bg-gradient-to-br from-emerald-50 via-lime-50/80 to-white dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 border-b border-emerald-100 dark:border-slate-700">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h3 className="font-bold text-2xl text-emerald-900 dark:text-slate-100">ثبت اتاق ریکاوری جدید</h3>
                        <p className="text-sm text-emerald-600/80 dark:text-slate-400 mt-1 flex items-center gap-1.5">
                            <span className="h-1.5 w-1.5 rounded-full bg-emerald-400 animate-pulse"></span>
                            اطلاعات مربوط به اتاق ریکاوری و رشد
                        </p>
                    </div>
                </div>
            </div>
